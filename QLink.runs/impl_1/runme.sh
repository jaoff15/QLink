...
HD_PWD='/home/jacoboffersen/advanced_programmable_electronics/QLink_/QLink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log receiver_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source receiver_top.tcl -notrace
