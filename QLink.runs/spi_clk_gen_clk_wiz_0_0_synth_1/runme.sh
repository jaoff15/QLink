...
HD_PWD='/home/jacoboffersen/advanced_programmable_electronics/QLink_/QLink.runs/spi_clk_gen_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spi_clk_gen_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spi_clk_gen_clk_wiz_0_0.tcl
