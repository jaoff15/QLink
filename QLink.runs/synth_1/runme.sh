...
HD_PWD='/home/jacoboffersen/advanced_programmable_electronics/QLink_/QLink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log receiver_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source receiver_top.tcl
